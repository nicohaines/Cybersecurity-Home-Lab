...
Here is an example where I am able to access the root shell by abusing system():
...
![](Screenshots/30.png)
    ...
    However, in my demonstration execve() also accessed the root shell. I suspect there is still a way the code ends up invoking /bin/sh or otherwise allowing the shell to be executed, so I will research this further to identify the exact issue. Technically, execve() should be safer.
    ![](Screenshots/31.png)
